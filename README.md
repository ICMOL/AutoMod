...
- For multiple pepXML files
  > `xjar.exe java --add-opens java.base/jdk.internal.loader=ALL-UNNAMED -jar AutoMod.jar path\AutoMod.yml path\file1.pepXML path\file2.pepXML path\file3.pepXML`
  > 
